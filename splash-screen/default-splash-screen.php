...
$title_ = esc_attr( get_option(SAM_SPLASHSCREEN_TITLE, SAM_DEFAULT_SPLASHSCREEN_TITLE) );
$message_ = esc_attr( get_option(SAM_SPLASHSCREEN_MESSAGE, SAM_DEFAULT_SPLASHSCREEN_MESSAGE) );
